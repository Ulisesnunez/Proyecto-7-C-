...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2022 a las 13:16:23
...
ALTER TABLE `pedidos_datos`
  ...
  ADD CONSTRAINT `pedidos_datos_ibfk_2` FOREIGN KEY (`articulo`) REFERENCES `catalogo` (`nro_producto`) ON UPDATE CASCADE;
COMMIT;
