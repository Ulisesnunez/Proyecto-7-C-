...
<body>
    ...
    <div class="flex font-sans intento bg">
        <div class="flex-none w-50  relative">
          <img src="imagenesropa/imagen11.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
        </div>
        <form class="flex-auto p-6">
          <div class="flex flex-wrap">
            <h1 class="flex-auto text-lg font-semibold text-slate-900">
              Uniforme completo JUAN XXIII
            </h1>
